class_name BotaoComprarCartasBaralho extends Button
...
func _ready() -> void:
	...
	original_position_y = texturaBotao.position.y
...
func _on_mouse_entered() -> void:
	...
	tween.tween_property(texturaBotao, "position:y", original_position_y + 10, 0.2)
...
func _on_mouse_exited() -> void:
	...
	tween.tween_property(texturaBotao, "position:y", original_position_y, 0.2)
